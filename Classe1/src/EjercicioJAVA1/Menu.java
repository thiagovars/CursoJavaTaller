...
public class Menu {
	public static void showMenu(String menu) {
		...
		case "merienda":
			...
			System.out.println("- Refuerzo de muzarela con jamón");
			break;
		case "cena":
