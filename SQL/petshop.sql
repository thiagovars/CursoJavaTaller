...
INSERT INTO REL_DIR_BAR_CLI (numPuerta, barrio, cliente) VALUES 
('3054', 1, 4),
('125',  2, 3),
('7801', 3, 5),
('1195', 4, 7),
...
/*27*/ INCOMPLETA
SELECT * FROM AGENDA
WHERE DAYOFWEEK(AGENDA.FECHA) = 6;

/*30*/ 
SELECT EMP.*, COCHE.* FROM AGENDA
INNER JOIN REL_COCH_AGD_EMP RCOCHE ON RCOCHE.COCHE = AGENDA
INNER JOIN EMPLEADO EMP ON EMP.CODEMP = RCOCHE.EMPLEADO1
INNER JOIN COCHE ON COCHE.CODCOCHE = RCOCHE.COCHE
WHERE AGENDA.FECHA = '2016-02-11' AND AGENDA.CLIENTE = 9 AND COCHE.CODCOCHE = 2;