...
('2017-05-13 10:10:00', 4, 5),
('2017-05-13 11:00:00', 15, 7),
('2017-05-13 12:00:00', 18, 9),
('2017-05-13 13:30:00', 19, 5),
('2017-05-13 14:10:00', 5, 6),
('2017-05-13 15:00:00', 8, 7),
('2017-05-13 8:00:00', 9, 10),
('2017-05-13 9:00:00', 11, 24),
('2017-05-13 10:10:00', 12, 15),
('2017-05-13 11:00:00', 21, 11),
('2017-05-13 12:00:00', 24, 14),
('2017-05-13 13:30:00', 7, 8),
('2017-05-13 14:10:00', 17, 21),
('2017-05-13 15:00:00', 22, 11);
...
/*colega consulta complicada*/
SELECT * FROM EVENTOS
INNER JOIN MASCOTAS ON MASCOTAS.IDMASCOTA = EVENTOS.IDMASCOTA
INNER JOIN CLIENTE ON CLIENTE.IDCLIENTE = MASCOTAS.IDCLIENTE
WHERE CLIENTE.IDCLIENTE IN (SELECT IDCLIENTE FROM (SELECT CLIENTE.IDCLIENTE AS "idcliente", COUNT(CLIENTE.IDCLIENTE) AS "count" FROM EVENTOS
INNER JOIN MASCOTAS ON MASCOTAS.IDMASCOTA = EVENTOS.IDMASCOTA
INNER JOIN CLIENTE ON CLIENTE.IDCLIENTE = MASCOTAS.IDCLIENTE
